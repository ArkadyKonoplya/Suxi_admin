...
export class FixedpluginComponent implements OnInit {
  ...
  ngOnInit() {
      ...
      $('.fixed-plugin a').click(function(event:Event) {
        ...
        // so the dropdown will not be hide, otherwise we set the  section active
          if ($(components).hasClass('switch-trigger')) {
      ...
      $('.fixed-plugin .active-color span').click(function() {
          ...
          $(components).siblings().removeClass('active');
          $(components).addClass('active');
          const new_color = $(components).data('color');
      ...
      $('.fixed-plugin .img-holder').click(function() {
          ...
          $(components).parent('li').siblings().removeClass('active');
          $(components).parent('li').addClass('active');

          let new_image = $(components).find('img').attr('src');
